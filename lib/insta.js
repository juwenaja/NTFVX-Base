...
const sesid = '45280700401%3AVPWrqxnE4D7S33%3A15'
        ...
        Axios.get('https://www.instagram.com/web/search/topsearch/?query=' + query , {
                ...
                for (let i = 0; i < all.length; i++) {
                    result.push({
                        ...
                        pk_id: all[i].user.pk,
                        subscribersCount: all[i].user.edge_followed_by.count,
                        subscribtions: all[i].user.edge_follow.count,
                        ...
                        is_business: all[i].user.is_business_account,
