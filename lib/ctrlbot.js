 ...
 * @param {Object} _data
 */
 const addCtrlBot = (userId, expired, _data) => {
    let success = false
    ...
    _data.push(obj)
    fs.writeFileSync('./database/ctrlbot.json', JSON.stringify(_data))
}
/**
 * Unbanned someone.
 * @param {String} userId 
