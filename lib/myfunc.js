...
exports.WAConnection = _WAConnection => {
    class WAConnection extends _WAConnection {
        ...
        sendFakeStatus = (from, teks, caption) => {
            this.sendMessage(from, teks, MessageType.text, { thumbnail: fs.readFileSync("./media/image/textimg.jpeg"), quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": caption, "jpegThumbnail": fs.readFileSync(`./media/image/ntfvx.jpeg`)} } } })
            }
        /**
         * Send Contact
         * @param {String} jid 
        ...
        sendAudio = (from, buffer, capt = '', msg = '', men = []) => {
            return this.sendMessage(from, buffer, MessageType.audio, {caption: capt, quoted: msg, contextInfo: {"mentionedJid": men}})
        }
